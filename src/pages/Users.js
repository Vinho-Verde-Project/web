    ...
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            {isEdit
              ? "Formulary to modify data of an existing user."
              : "Formulary to register new user."}
          </DialogContentText>
          ...
          <TextField
            ...
            onChange={(e) =>
              setdialogContent({ ...dialogContent, firstName: e.target.value })
            }
          />
          <TextField
            margin="dense"
            ...
            onChange={(e) =>
              setdialogContent({ ...dialogContent, lastName: e.target.value })
            }
          />
            ...
            <Grid item xs={6}>
              <Box marginRight={1}>
                <TextField
                  ...
                  onChange={(e) =>
                    setdialogContent({ ...dialogContent, nif: e.target.value })
                  }
                />
              </Box>
            </Grid>
            <Grid item xs={6}>
              <Box marginLeft={1}>
                <TextField
                  ...
                  fullWidth
                  defaultValue={
                    isEdit ? convertDate(dialogContent.birthday) : ""
                  }
                  onChange={(e) =>
                    setdialogContent({
                      ...dialogContent,
          ...
          <TextField
            ...
            label="Full Address"
            onChange={(e) =>
              setdialogContent({ ...dialogContent, address: e.target.value })
            }
          ...
          >
            <Box marginRight={1}>
              <TextField
                ...
                onChange={(e) =>
                  setdialogContent({ ...dialogContent, email: e.target.value })
                }
                fullWidth
              />
            </Box>
            <Box marginLeft={1}>
              <ReactPhoneInput
                ...
                component={TextField}
                onChange={(e) =>
                  setdialogContent({ ...dialogContent, phone: e })
                }
          ...
          >
            ...
            <Grid item xs={6}>
              <Box ml={1} xs={6}>
                <InputLabel htmlFor="standard-key-native-simple">
                  Role
                </InputLabel>
                <Select
                  fullWidth
                  ...
                  variant="standard"
                  onChange={(e) =>
                    setdialogContent({ ...dialogContent, role: e.target.value })
                  }
        ...
        <DialogActions>
          ...
          <Button
            onClick={
              isEdit ? handleDialogSendEditUser : handleDialogSendNewUser
            }
            size="large"
            className={
              isEdit ? classes.modalButtonEdit : classes.modalButtonRegister
            }
          >
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            className={classes.modalButtonRemove}
            color="primary"
            autoFocus
          >
            Remove
